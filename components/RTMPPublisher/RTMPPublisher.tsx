...
import { findNodeHandle, NativeModules, type ViewStyle } from 'react-native';
...
const RTMPPublisher = forwardRef<RTMPPublisherRefProps, RTMPPublisherProps>(
  (
    ...
    const toggleCamera = (isVisible: boolean, viewId: any) => RTMPModule.toggleCameraFragment(isVisible, viewId);
    ...
    const getNativeHandle = () => {

      return findNodeHandle(myRef.current)
    }
